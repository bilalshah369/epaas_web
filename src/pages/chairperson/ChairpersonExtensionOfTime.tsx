...
import { fetchChairpersonExtensions } from '@/services/chairperson.service';
...
export default function ChairpersonExtensionOfTime() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try { setRequests(await fetchChairpersonExtensions()); } finally { setLoading(false); }
  }, []);
