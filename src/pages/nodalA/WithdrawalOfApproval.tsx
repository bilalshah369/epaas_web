// Mirrors NodalWithdrawal from mock (App.jsx L14676).
// Withdrawal requests are not yet in schema — table shows empty state.
    ...
    <div>
      ...
      <div style={{ background: COLORS.white, border: `1px solid ${COLORS.border}`, borderRadius: 8, overflow: 'hidden' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
          <thead>
            <tr>
              {['Sr. No.', 'Approval No.', 'Company / Org.', 'Issue Date', 'Request Date', 'Status', 'Action'].map((h) => (
          ...
          <tbody>
            <tr>
              <td colSpan={7} style={{ ...S.td, textAlign: 'center', color: COLORS.textMuted, padding: 32 }}>
