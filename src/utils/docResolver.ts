...
export function getComplianceItems(app: Application | null): ComplianceRow[] {
  ...
  if (type === 'AyurvedaAahara' || type === 'AA') {
    return [
      ...
      { label: 'Product Formulation Submitted',       passed: has('formulationDetails') },
      ...
      { label: 'Composition Document Uploaded',       passed: has('compositionFile') || has('ingredientListFile') },
